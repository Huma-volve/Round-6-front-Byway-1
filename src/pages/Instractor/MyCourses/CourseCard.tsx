      ...
      {isEditing ? (
        ...
        <>
          ...
          <div className="flex justify-between mt-4">
            ...
            <Link to='/instructor/coursedetails'>
              <button className="px-3 py-1 rounded bg-neutral-500 text-white text-sm hover:bg-neutral-200 hover:text-black cursor-pointer">
                Details
              </button>
            </Link>
